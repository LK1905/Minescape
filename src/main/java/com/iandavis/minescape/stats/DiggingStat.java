...
public class DiggingStat extends Stat{

	EntityLivingBase entity;
	EntityPlayer player = Minecraft.getMinecraft().player;
	
	ISkill skill = CapabilityUtils.getCapability(player, CapabilitySkills.getSkillCapability(), null).getSkill("Digging");
	
	public DiggingStat(EntityLivingBase entity) {
		super(entity);
		this.entity = entity;
	}
